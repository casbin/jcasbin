...
public class Enforcer extends ManagementEnforcer {
  ...
  /**
   * updatePermissionForUser updates a permission for a user or role. Returns false if the user or
   * role already has the permission (aka not affected).
   *
   * @param user the user.
   ...
   * @return succeeds or not.
   */
  public boolean updatePermissionForUser(
