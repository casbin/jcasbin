...
/**
 * FilteredAdapter is the filtered file adapter for Casbin. It can load policy from file or save
 * policy to file and supports loading of filtered policies.
 *
 * @author tldyl
 * @since 2020/6/8
 */
public class FilteredAdapter implements org.casbin.jcasbin.persist.FilteredAdapter {
  ...
  private void loadFilteredPolicyFile(
      Model model, Filter filter, Helper.loadPolicyLineHandler<String, Model> handler)
