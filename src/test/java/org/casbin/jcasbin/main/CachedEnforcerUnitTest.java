...
public class CachedEnforcerUnitTest {
    ...
    public void testCache() {
        ...
        // The cache is enabled by default for CachedEnforcer.
    ...
    public void testKeyMatchModelInMemory() {
        ...
        Enforcer e = new CachedEnforcer(m, a);
    ...
    public void testRBACModelInMemoryIndeterminate() {
        ...
        Enforcer e = new CachedEnforcer(m);
    ...
    public void testReloadPolicy() {
        Enforcer e = new CachedEnforcer("examples/rbac_model.conf", "examples/rbac_policy.csv");
    ...
    public void testEnableEnforce() {
        Enforcer e = new CachedEnforcer("examples/basic_model.conf", "examples/basic_policy.csv");
    ...
    public void testEnableLog() {
        Enforcer e = new CachedEnforcer("examples/basic_model.conf", "examples/basic_policy.csv", true);
        // The log is enabled by defaulso the above is the same with:
        // Enforcer e = new CachedEnforcer("examples/basic_model.conf", "examples/basic_policy.csv");
    ...
    public void testInitWithAdapter() {
        ...
        Enforcer e = new CachedEnforcer("examples/basic_model.conf", adapter);
    ...
    public void testRoleLinks() {
        Enforcer e = new CachedEnforcer("examples/rbac_model.conf");
    ...
    public void testGetAndSetModel() {
        CachedEnforcer e = new CachedEnforcer("examples/basic_model.conf", "examples/basic_policy.csv");
        Enforcer e2 = new CachedEnforcer("examples/basic_with_root_model.conf", "examples/basic_policy.csv");
    ...
    public void testGetAndSetAdapterInMem() {
        CachedEnforcer e = new CachedEnforcer("examples/basic_model.conf", "examples/basic_policy.csv");
        Enforcer e2 = new CachedEnforcer("examples/basic_model.conf", "examples/basic_inverse_policy.csv");
    ...
    public void testSetAdapterFromFile() {
        Enforcer e = new CachedEnforcer("examples/basic_model.conf");
