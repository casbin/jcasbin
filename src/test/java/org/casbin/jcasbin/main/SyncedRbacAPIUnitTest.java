...
public class SyncedRbacAPIUnitTest {
  ...
  public void testImplicitRoleAPI() {
    Enforcer e =
        new SyncedEnforcer("examples/rbac_model.conf", "examples/rbac_with_hierarchy_policy.csv");
  ...
  public void testImplicitPermissionWithoutRoleAPI() {
    Enforcer e =
        new SyncedEnforcer(
            "examples/rbac_model.conf", "examples/rbac_with_hierarchy_policy_without_role.csv");
    assertEquals(
        e.getImplicitPermissionsForUser("alice"),
