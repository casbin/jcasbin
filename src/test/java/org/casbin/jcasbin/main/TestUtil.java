...
public class TestUtil {
  ...
  static void testEnforceWithMatcher(
      Enforcer e, String matcher, Object sub, Object obj, String act, boolean res) {
  ...
  static void testDomainEnforce(
      Enforcer e, Object sub, Object dom, Object obj, Object act, boolean res) {
  ...
  static void testGetFilteredPolicy(
      Enforcer e, int fieldIndex, List<List<String>> res, String... fieldValues) {
    ...
    if (!Util.array2DEquals(res, myRes)) {
      fail(
          "Policy for "
              + Util.paramsToString(fieldValues)
              + ": "
              + myRes
              + ", supposed to be "
              + res);
  ...
  static void testGetFilteredGroupingPolicy(
      Enforcer e, int fieldIndex, List<List<String>> res, String... fieldValues) {
  ...
  static void testGetPermissionsInDomain(
      Enforcer e, String name, String domain, List<List<String>> res) {
  ...
  static void testGetImplicitPermissionsInDomain(
      Enforcer e, String name, String domain, List<List<String>> res) {
  ...
  static void testEval(
      String eval, Map<String, Object> env, AviatorEvaluatorInstance aviatorEval, boolean res) {
