...
public class BenchmarkCachedRBACModelWithDomains {
    private static CachedEnforcer e = new CachedEnforcer("examples/rbac_with_domains_model.conf", "examples/rbac_with_domains_policy.csv", false);
    ...
    @Threads(1)
    @Benchmark
    public static void benchmarkCachedRBACModelWithDomains() {
